                    ...
                    <body>
                        <div class="container">
                            ...
                            <div class="content">
                                ...
                                <p><a target="_blank" href="https://lemonteams.onrender.com/verify?identity=${identity}" class="button" style="color: #fff;">Confirm Email</a></p>
                                <br>
...
const LemonColorLab = async (req, res) => {
    try {
        ...
        const sponsered = await Palette.find({ visibility: "public", "sponser": true }).sort({ sponser_expires: -1 });
